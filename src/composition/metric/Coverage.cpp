...
std::set<llvm::Instruction *> Coverage::ValuesToInstructions(const std::set<llvm::Value *> &values) {
...
std::set<llvm::BasicBlock *> Coverage::InstructionsToBasicBlocks(const std::set<llvm::Instruction *> &instructions) {
...
std::set<llvm::Function *> Coverage::BasicBlocksToFunctions(const std::set<llvm::BasicBlock *> &basicBlocks) {
