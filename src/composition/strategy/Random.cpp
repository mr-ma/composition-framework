...
Manifest* Random::decideCycle(std::vector<Manifest*> manifests) { return decide(manifests); }

Manifest* Random::decidePresentPreserved(std::vector<Manifest*> manifests) { return decide(manifests); }
